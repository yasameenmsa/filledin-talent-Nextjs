...
//             </div>
//             <div className={currentLanguage === 'ar' ? "text-right" : "text-left"}>
//               <label htmlFor="category" className="block text-sm font-semibold text-gray-900 mb-2 px-4">
//               </label>
//               <input
//                 type="text"
//                 id="category"
//                 placeholder={text.category}
//                 className="w-full placeholder-black text-black  px-4 py-2 border border-gray-300 rounded-md focus:text-black focus:outline-none focus:ring-2 focus:ring-blue-500 block text-sm font-semibold  mb-2"
//               />
//             </div>
//             <div className={currentLanguage === 'ar' ? "text-right" : "text-left"}>
            ...
            <div className="grid grid-cols-2 gap-8 max-w-3xl mx-auto mb-10">
              <div>
                <input
                  ...
                  id="keywords"
                  placeholder={text.keywords}
                  className="w-full placeholder-black text-black px-4 py-3 border border-gray-300 rounded-md focus:text-black focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm font-semibold"
                />
              </div>
