      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="flex-1">
            <p className="text-lg leading-relaxed mb-8" style={{ color: '#000' }}>{text.intro}</p>
            <ul className="space-y-6">
              <li className="flex gap-3">
                <span className="flex-shrink-0 mt-2">
                  <div className="w-2 h-2 rounded-full bg-black"></div>
                </span>
                <p className="text-base leading-relaxed" style={{ color: '#000' }}>{text.upstream}</p>
              </li>
              <li className="flex gap-3">
                <span className="flex-shrink-0 mt-2">
                  <div className="w-2 h-2 rounded-full bg-black"></div>
                </span>
                <p className="text-base leading-relaxed" style={{ color: '#000' }}>{text.downstream}</p>
              </li>
              <li className="flex gap-3">
                <span className="flex-shrink-0 mt-2">
                  <div className="w-2 h-2 rounded-full bg-black"></div>
                </span>
                <p className="text-base leading-relaxed" style={{ color: '#000' }}>{text.renewable}</p>
              </li>
            </ul>
          </div>
          ...
          <div className="flex-shrink-0 lg:w-[600px]">
            <Image
              src="/images/business/DeeplySpecializedSourcing.png"
            ...
            />
            <p className="text-xs text-gray-500 mt-2 text-center italic">Energy Value Chain: Upstream, Midstream & Downstream Operations</p>
          </div>
        </div>
      </div>
    </div>
