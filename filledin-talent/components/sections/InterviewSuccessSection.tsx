  ...
  const getText = (currentLanguage: string) => {
    const translations = {
      en: {
        ...
        tip1: 'Know the Company: Dive deep into the company\'s profile, culture, turnover, and short-term and long-term strategies. Understanding what drives the organization helps you align your goals with theirs.',
        tip2: 'Reflect on the Role: Take time to analyse the job description and evaluate your personal motivation for the position. Why are you the perfect fit?',
