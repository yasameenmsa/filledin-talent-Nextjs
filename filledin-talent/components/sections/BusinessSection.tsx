...
const translations = {
  ...
  fr: {
    ...
    intro: 'FilledIn Talent s\'engage à vous fournir un recrutement prêt pour l\'avenir, une main-d\'œuvre spécialisée dans l’énergie de demain.',
    partnership: 'Nous nous associons avec des employeurs comme vous afin de créer des équipes à long terme ayant d’excellentes compétences dans l’industrie en évolution rapide de l’énergie renouvelable et non renouvelable. Nous proposons également une main-d\'œuvre flexible pour maintenir des projets critiques à court ou long-terme.',
