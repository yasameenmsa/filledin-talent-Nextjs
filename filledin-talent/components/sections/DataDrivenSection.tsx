  ...
  const getText = (currentLanguage: string) => {
    const translations = {
      en: {
        ...
        noSecondInterview: 'No Hire, No Fee',
        noSecondInterviewDesc: 'We de-risk your investment. You incur no upfront or milestone fees. Full fee only due 14 days after candidate starts.',
      ...
      fr: {
        ...
        noSecondInterview: 'Pas d\'embauche, pas de frais',
        noSecondInterviewDesc: 'Nous réduisons les risques de votre investissement. Vous ne payez aucun frais initial ni d\'étape. L\'intégralité des honoraires n\'est due que 14 jours après la prise de poste du candidat.',
      ...
      ar: {
        ...
        noSecondInterview: 'لا توظيف، لا رسوم',
        noSecondInterviewDesc: 'نقلل من مخاطر استثمارك. لا تتحمل أي رسوم مقدمة أو رسوم على المراحل. الرسوم الكاملة مستحقة فقط بعد 14 يومًا من بدء المرشح العمل.',
