  ...
  const getText = (lang: string) => {
    const translations = {
      ...
      fr: {
        ...
        p2: 'Nous parlons le langage de l\'énergie. Contrairement aux entreprises généralistes, nous fournissons des candidats qui sont de véritables spécialistes, avec une expertise approfondie dans des domaines tels que les unités FCC (Fluid Catalytic Cracking) ou les collecteurs sous-marins et l\'arbitrage commercial. Cela vous permet de contourner les longues explications et de vous concentrer sur la sélection du bon candidat.',
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start">
          ...
          <div className="flex-1 space-y-6">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-8 leading-tight" style={{ color: '#000' }}>
              {text.title}
            </h2>
          ...
          <div className="flex-shrink-0 w-full lg:w-[450px] xl:w-[500px]">
            <div className="relative w-full">
              ...
              >
                <Image
                  src="/images/about/ArabWomen2.png"
