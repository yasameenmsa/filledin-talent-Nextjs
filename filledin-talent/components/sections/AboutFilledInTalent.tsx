  ...
  const getText = (lang: string) => {
    const translations = {
      en: {
        ...
        p2: 'We speak the language of energy. Unlike generalist firms, we deliver candidates who are true specialists, with deep expertise in areas like FCC units and subsea manifolds. This allows you to bypass lengthy explanations and focus on selecting the right fit.',
        p3: 'Our mission is to help companies in the Middle East and Africa build agile, future-ready workforces. We achieve this by combining our deep regional expertise in complex markets like Saudi Arabia, Kuwait, UAE, Qatar, Libya, Nigeria and Algeria with a modern, technology-driven approach.',
        ...
        p5: 'At our core, we believe recruitment should be strategic, transparent, and human-centered. FilledIn Talent is committed to global best practices in compliance with diversity, equity, and inclusion, while also building partnerships that power progress responsibly.',
        imageCaption: 'Arabic business women picture'
      },
      fr: {
        title: 'À propos de FilledIn Talent',
        p1: 'FilledIn Talent (FINT) est un partenaire de recrutement spécialisé dans le secteur énergétique mondial. Nous fournissons des solutions de talents, experts à travers l\'ensemble du cycle de vie des hydrocarbures - de l\'exploration en amont et du raffinage en aval au négoce de pétrole brut - ainsi que dans le paysage en expansion rapide des énergies renouvelables.',
        p2: 'Nous parlons le langage de l\'énergie. Contrairement aux entreprises généralistes, nous fournissons des candidats spécialistes, avec une expertise approfondie dans des domaines tels que les unités FCC (Fluid Catalytic Cracking) ou les collecteurs sous-marins. Cela vous permet de contourner les longues explications et de vous concentrer sur la sélection du bon candidat.',
        p3: 'Notre mission est d\'aider les entreprises du Moyen-Orient et d\'Afrique à constituer des équipes agiles et prêtes pour l\'avenir. Nous y parvenons en combinant notre profonde expertise régionale dans des marchés complexes comme l\'Arabie saoudite, le Kuwait, l’UAE, le Qatar, la Libye, le Nigeria et l’Algerie avec une approche moderne axée sur la technologie.',
        p4: 'Notre processus exploite l\'IA pour améliorer l\'efficacité de nos consultants, garantissant une correspondance proactive et précise entre des candidats exceptionnels et des opportunités de carrière transformatrices.',
      ...
      <div className="container mx-auto max-w-7xl">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center lg:items-start">
          ...
          <div className="flex-1 space-y-6">
            <h2 className="text-4xl font-bold mb-8 leading-tight" style={{ color: '#000' }}>
              {text.title}
            </h2>

            <p className="text-base md:text-base leading-relaxed" style={{ color: '#000' }}>
              {text.p1}
            </p>
          ...
          {/* Right Image */}
          <div className="flex-shrink-0 w-full max-w-[350px] lg:max-w-none lg:w-[450px] xl:w-[500px]">
            <div className="relative w-full">
              ...
              >
                <Image
                  src="/images/about/ArabWomen3.jpg"
